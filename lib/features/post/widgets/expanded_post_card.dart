...
class ExpandedPostCard extends ConsumerStatefulWidget {
  final Post post;
  const ExpandedPostCard({Key? key, required this.post}) : super(key: key);

  @override
  _ExpandedPostCardState createState() => _ExpandedPostCardState();
}

class _ExpandedPostCardState extends ConsumerState<ExpandedPostCard> {
